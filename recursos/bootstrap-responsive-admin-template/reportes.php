...
<head>
<meta charset="utf-8">
<title>Reportes - Control de Pacientes de Medicina Est&eacute;tica</title>
      ...
      <div class="row">
        <div class="span12">
          <div class="widget widget-nopad">
            <div class="widget-header"> <i class="icon-file-text-alt"></i>
              <h3> Reporte de ingresos de pacientes </h3>
            </div>
            <!-- /widget-header -->
            <div class="widget-content" style="padding:10px">
                <table width="100%" cellpadding="0" cellspacing="0">
                	<tr>
                        <td colspan="2">
                        	<table cellpadding="0" cellspacing="0">
                            	<tr>
                                	<td>
                                        De&nbsp;<br><input type="text" style="margin-bottom:0px; width:50%" /><i class="btn-icon-only icon-calendar" style="font-size:16px"> </i>
                                    </td>
                                    <td>
                                        &nbsp;Hasta&nbsp;<br><input type="text" style="margin-bottom:0px; width:50%" /><i class="btn-icon-only icon-calendar" style="font-size:16px"> </i>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                          ...
                          <input type="text" id="nombrePaciente" style="width:92%" />
                     	</td>
                        <td style="padding-top:10px">
                    ...
                    <tr>
                   	  	<td style="padding-top:10px">
                        	Tipo de cirug&iacute;<br>
                          <select id="cirugia" style="width:92%">
