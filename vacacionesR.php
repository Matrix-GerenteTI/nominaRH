      ...
      <div class="modal-body">
		...
		<table width="100%">
			<tr>
				<td>
					Departamento<br/>
					<select id="busdepartamento" style="width:92%"><option value='%'></option></select>
				</td>
				<td>
					Nombre<br/>
...
listarTrabajadoresConVacaciones(fechaHoy.getFullYear());
buslista();
    ...
    $('#filtroPeriodo').datepicker({
        onSelect: function (fd , date) {
          ...
          listarTrabajadoresConVacaciones(date.getFullYear())
        }
    })
