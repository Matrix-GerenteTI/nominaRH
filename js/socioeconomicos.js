...
var getDatosTrabajador = function getDatosTrabajador(trabajador) {
  ...
  $.post("/nomina/ajax/controladores/socioeconomico.php?opc=getImagenes", {empleado: trabajador}, function (resp) {
    $("#comprobantessoc").html(resp)
  });
};
    ...
    if (data.evaluacion.length > 0) {
      ...
      var _loop = function _loop(i) {
        ...
        if (pregunta.seccion != seccion || pregunta.seccion == '') {
          ...
          templatePreguntas = "<div class='row'><div class='col-12'><label><h4>".concat(pregunta.descripcion, "</h4></label></div></div>");

          if (pregunta.opciones.length > 0) {
            templatePreguntas += "<div class='row'>";
            $.each(pregunta.opciones, function (j, itemOpcion) {
              if (itemOpcion.tipo == 'checkbox') {
                templatePreguntas += "<div class='col-12'><div class='form-check mb-2'><input type=\"".concat(itemOpcion.tipo, "\" value=\"").concat(itemOpcion.descripcion, "\" id=\"opc-").concat(itemOpcion.id, "\" ").concat(itemOpcion.checked, " class=\"preg-").concat(pregunta.id, " form-check-input\"><label class='form-check-label' for='opc-"+itemOpcion.id+"'>"+itemOpcion.descripcion+"</label></div></div>");
              } else {
                templatePreguntas += "<div class='col-12'><label>".concat(itemOpcion.descripcion, " </label><input type=\"text\" id=\"opc-").concat(itemOpcion.id, "\" class=\"preg-").concat(pregunta.id, " form-control\" value=\"").concat(pregunta.respuesta != null ? pregunta.respuesta : '', "\"></div>");
              }
            });
            templatePreguntas += "</div>";
          } else if (pregunta.tipo != 'empty') {
            if (pregunta.tipo == 'ingreso' || pregunta.tipo == 'gasto' || pregunta.tipo == 'creditos') {
              $("#t".concat(pregunta.tipo)).append("<div class='row'><div class='col-12'><label><h4>".concat(pregunta.descripcion, "</h4></label><input type=\"text\" id=\"preg-").concat(pregunta.id, "\" value=\"").concat(pregunta.respuesta != null ? pregunta.respuesta : '', "\" class=\"form-control\"> </div></div>"));
            } else {
              templatePreguntas += "<div class='row'><div class='col-12'><input type=\"".concat(pregunta.tipo, "\" id=\"preg-").concat(pregunta.id, "\" value=\"").concat(pregunta.respuesta != null ? pregunta.respuesta : '', "\" class=\"form-control\"></div></div>");
            }
          }
          ...
          if (pregunta.tipo == 'check') {
            templateChecks = "<hr/><div class='row'><div class='col-12'><label><h4>".concat(pregunta.descripcion, "</h4></label></div></div><div class='row'>");
            $.each(pregunta.opciones, function (j, respuestasCheck) {
              if (respuestasCheck.tipo == 'checkbox') {
                templateChecks += "<div class='col-12'><div class='form-check mb-2'><input type=\"".concat(respuestasCheck.tipo, "\" ").concat(respuestasCheck.checked, " value=\"").concat(respuestasCheck.descripcion, "\" id=\"opc-").concat(respuestasCheck.id, "\" class=\"preg-").concat(pregunta.id, " form-check-input\"></label><label class='form-check-label' for='opc-"+respuestasCheck.id+"'>"+respuestasCheck.descripcion+"</label></div></div>");
              } else {
                templateChecks += "<div class='col-12'><label>".concat(respuestasCheck.descripcion, " </label><input type=\"text\" class=\"preg-").concat(pregunta.id, "\" opc=\"opc-").concat(respuestasCheck.id, "\" value=\"").concat(pregunta.respuesta != null ? pregunta.respuesta : '', "\" class=\"form-control\"></div>");
              }
            });
            templateChecks += "</div>";
            templatePreguntas += templateChecks;
            ...
            if (pregunta.tipo == 'ingreso' || pregunta.tipo == 'gasto' || pregunta.tipo == 'creditos') {
              ...
              pregunta.tipo = pregunta.tipo != 'text' ? 'text' : pregunta.tipo;
              templatePreguntas += "<div class='row'><div class='col-12'><label><h4>".concat(pregunta.descripcion, "</h4></label><input type=\"").concat(pregunta.tipo, "\" id=\"preg-").concat(pregunta.id, "\" value=\"").concat(pregunta.respuesta != null ? pregunta.respuesta : '', "\" class=\"form-control\"></div></div>");
            } else {
              templatePreguntas += "<div class='row'><div class='col-12'><label><h3>".concat(pregunta.descripcion, "</h3></label></div></div>");
            }
          }
