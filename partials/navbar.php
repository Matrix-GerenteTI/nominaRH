<nav class="navbar">
    ...
    <div class="navbar-content">
        ...
        <ul class="navbar-nav">
            ...
            <!-- ::: MAILBOX ::: <li class="nav-item dropdown">
            ...
            <!-- ::: CHATBOX ::: <li class="nav-item dropdown">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="wd-30 ht-30 rounded-circle" src="<?=$_SESSION['usernip']>0?'/intranet/Empresa/foto_empleado/'.$_SESSION['usernip'].'.jpg':'assets/images/person-icon.png'?>" alt="profile">
                </a>
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                        <div class="mb-3">
                            <img class="wd-80 ht-80 rounded-circle" src="<?=$_SESSION['usernip']>0?'/intranet/Empresa/foto_empleado/'.$_SESSION['usernip'].'.jpg':'assets/images/person-icon.png'?>" alt="">
                        </div>
                        <div class="text-center">
                            <p class="tx-16 fw-bolder"><?=$_SESSION['username']?></p>
                            <p class="tx-12 text-muted"><?=$_SESSION['usertype']?></p>
                        </div>
                    </div>
                    <ul class="list-unstyled p-1">
                        ...
                        <li class="dropdown-item py-2">
                            <a href="ajax/control.php?closeSesion=y" class="text-body ms-0" style="background:rgba(0,0,0,0) !important">
